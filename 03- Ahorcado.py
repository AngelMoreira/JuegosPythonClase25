...
def ahorcado():
    ...
    letras_adivinadas = [palabra_secreta[0]]  # Revelamos la primera letra como pista
    intentos = 6

    print("¡Bienvenido al juego del Ahorcado!")
    print(f"La palabra está relacionada con programación y empieza con la letra '{palabra_secreta[0]}'")
    print(" ".join([letra if letra in letras_adivinadas else "_" for letra in palabra_secreta]))
